...
export default function Trevel() {
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <h1 className="text-2xl font-semibold text-gray-900 mb-6">
                        Імпорт договір Тревел (дата народження Страхувальника)
                    </h1>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full  px-3 py-2 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                        ...
                        <div>
                            <label
                                ...
                                className="block text-sm font-medium text-gray-700 mb-2"
                            >
                                Введіть дату народження Страхувальника
                            </label>
                            <input
                                id="inputData"
                                type="date"
                                ...
                                className="w-full  px-3 py-2 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                                placeholder="Введіть дату народження Страхувальника"
                            />
                        </div>
                        <div>
                            <button
